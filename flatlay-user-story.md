...
![Screenshot 177](/uploads/screenshot-177.png "Screenshot 177")

Also, a user can follow other users. "**isNotified**" property is set in this entity. it  has explained in the *Notifications* section..
